...
program.command("optimize")
  ...
  .option("--ckpt-pause <seconds>", "Checkpoint pause time override in seconds (default: constants.json)")
  .option("--ckpt-resume <seconds>", "Checkpoint resume time override in seconds (default: constants.json)")
...
program.command("forecast-sweep")
  .description("Fixed-policy sensitivity sweep, re-optimization under forecast error, and the stale-aware adaptive controller")
  .requiredOption("--mode <mode>", "fixed (Phase 3), reopt (Phase 4), adaptive (Phase B.1), or adaptive-sensitivity (Phase B.1 recovery-vs-c)")
  ...
  .option("--train-years <list>", "Train years for adaptive c* selection (default 2022,2023,2024)", "2022,2023,2024")
  .option("--c-grid <list>", "c grid for adaptive c* selection (default 0,0.25,0.5,0.75,1,1.5,2)", "0,0.25,0.5,0.75,1,1.5,2")
  .option("--c-sensitivity <list>", "extended c grid for adaptive-sensitivity mode (default 0,0.25,0.5,0.75,1,1.5,2,3,4,6,8)", "0,0.25,0.5,0.75,1,1.5,2,3,4,6,8")

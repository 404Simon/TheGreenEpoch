...
## Changes to the original Beamer template

* 11.2024 Jonathan Fellerer (Informatik 7): It has been updated to the state of 2024 for the flag ```[institute=Tech]``` and can also be used to create branded posters.

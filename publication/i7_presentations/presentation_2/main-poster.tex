...
\usepackage[institute=Tech,
  %WordMark=None
  %WordMarkTitleRight = template-art/Tech/FAU_TechFak_EN_Q_RGB_blue.pdf,
  %WordMarkTitleRight = template-art/Tech/FAU_TechFak_Q_RGB_blue.pdf,
  ExtraLogo = template-art/i7-logo-text\fauThemeLanguage .pdf,
  size=a0,
...
\subtitle{The \LaTeX{} poster template according to the 2021 FAU
corporate guide}

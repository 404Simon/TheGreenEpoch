...
The effect ranges from approximately 5 percentage points of savings (Sweden) to
under 2 percentage points (China), confirming that hysteresis threshold choice
dominates start-date scheduling in the savings-overhead trade-off.
...
Figure~\ref{fig:pareto} shows that the best-scoring thresholds for each model vary from year

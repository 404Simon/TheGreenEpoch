...
\include{chapters/06-experimental-setup}
\include{chapters/07-results}
% \include{chapters/08-validation-verification}
...
% \include{chapters/96-acronyms}
% \include{chapters/97-nomenclature}
\include{chapters/98-listoffigures}
\include{chapters/99-listoftables}
\include{chapters/100-bibliography}
